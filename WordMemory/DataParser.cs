...
namespace WordMemory
{
    public static class DataParser
    {
        ...
        private static readonly char meanDataSeparator = '\n';
        ...
        public static void ParseImportData(string importedData, ref List<WordData> outWordDataList)
        {
            ...
            // 1. 단어 데이터들 분리.
            string[] splitedWordData = importedData.Split(wordSeparator);
        ...
        public static void ParseProgramSettingDataAndSet(string settingData)
        {
            ...
            string[] splitedData = settingData.Split(dataSeparator);
            Debug.Assert(splitedData.Length == 4, $"데이터에 이상이 있습니다. 데이터 구조 개수는 4개여야 하는데 {splitedData.Length}개 입니다.");
            ...
            // 4. (저장된)등록된 단어 수 추출
            Setting.SetWordCount(MyConverter.HexToInt32(splitedData[3]));
        }
    }
}
